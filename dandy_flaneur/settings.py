"""
Django settings for dandy_flaneur project.
...
WSGI_APPLICATION = 'dandy_flaneur.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Static and media files configs
    STATICFILES_STORAGE = 'custom_storages.StaticStorage'
    STATICFILES_LOCATION = 'static'
    DEFAULT_FILE_STORAGE = 'custom_storages.MediaStorage'
    MEDIAFILES_LOCATION = 'media'

    # Static and media URLs override for production version
...
SUMMERNOTE_CONFIG = {
    ...
    # Lazy initialization
    # If you want to initialize summernote at the bottom of the page, set this as True
